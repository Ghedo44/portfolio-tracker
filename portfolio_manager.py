from pt import Portfolio, Stock, ETF, Transaction, PortfolioFromCsv, Cash
...
if __name__ == "__main__":
    ...
    # transaction = Transaction(asset=stock, type="buy", amount=10, price=150, transaction_cost=10)
    ...
    # transaction = Transaction(asset=etf, type="buy", amount=5, price=400, transaction_cost=1)
    # portfolio.add_transaction(transaction)
